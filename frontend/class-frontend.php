...
class Frontend
{
    ...
    public function assets() {
        wp_enqueue_style($this->plugin_slug, plugin_dir_url(__FILE__).'css/wc-webpayplus-woocommerce-frontend.css', [], $this->version);
        wp_enqueue_script($this->plugin_slug, plugin_dir_url(__FILE__).'js/wc-webpayplus-woocommerce-frontend.js', ['jquery'], $this->version, true);
    }
