...
class Admin
{
    ...
    private function custom_settings_fields($field_args, $settings) {
        ...
        foreach ($field_args as $field) {
            ...
            $label = esc_attr__($field['label'], 'wc-webpayplus-woocommerce');
    ...
    public function assets() {
        wp_enqueue_style($this->plugin_slug, plugin_dir_url(__FILE__).'css/wc-webpayplus-woocommerce-admin.css', [], $this->version);
        wp_enqueue_script($this->plugin_slug, plugin_dir_url(__FILE__).'js/wc-webpayplus-woocommerce-admin.js', ['jquery'], $this->version, true);
    }
    ...
    public function render() {
        ...
        $submit_text = esc_attr__('Submit', 'wc-webpayplus-woocommerce');
